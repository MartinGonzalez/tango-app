import{j as t,C as H}from"./ComponentPreview.Dp77vx_l.js";import{r as w,R}from"./client.DQNo7nBM.js";function F(i){return`${i.filePath}:${i.side}:${i.lineNumber}`}function B(i){const e=[],n=i.split(/^diff --git /m).filter(Boolean);for(const o of n){const a=P(o);a&&e.push(a)}return e}function P(i){const e=i.split(`
