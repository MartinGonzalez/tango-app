...
```bash
bunx create-tango-instrument hello-world
# Choose: sidebar panel only, no backend
...
import { UIRoot, UIPanelHeader, UISection, UICard } from "@tango/instrument-ui/react";
